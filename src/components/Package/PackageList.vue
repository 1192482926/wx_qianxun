<template>
  <div class="packageList-pack">
    <!-- 头部 -->
    <el-row class="packageL-top">
      <el-col :span="4" class="search-box displayTable" style='position:fixed;left: 0;height:50px;'>
        <p class="teableCell">
          <i class="icon iconfont icon-sousuo-" style="font-size: 36px;"></i>
        </p>
      </el-col>
      <el-col :span="24" class="health-name displayTable" style="position: fixed;width: 100%;">
      ...
      <el-col :span="4" class="viewtype-switch displayTable" style='position: fixed;right: 0;' >
        <p class="teableCell" style='width:10px;   float: left;' @click="$store.commit('chengeStatus')">
          <i class="icon iconfont iconSize " style="font-size: 26px;" :classIcon-status='flagIcon' :class="[flagIcon ? 'icon-list' : 'icon-apps']"></i>
        </p>
      </el-col>
    </el-row>
    <!-- 内容 -->
