  ...
  <div>
    ...
    <el-row :gutter="20" class='examination marginAll'>
      <el-col :span="6" v-for="(item,index) in project" v-if="index<8" :key="index">
        <router-link :to="{path:'/packageList'}">
          <div class="grid-content bg-purple">
    ...
    <el-row :gutter="20" class='marginAll paddingBuyTop'>
      <el-col :span="12">
        ...
        <div class="grid-content bg-purple">
          <router-link to='/healthProduct'>
            <img :src='hotBuy' class='imgHeight' />
          </router-link>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div class="grid-content bg-purple">
          <router-link to='/packageList'>
            <img :src='recommend' class='imgHeight' />
          </router-link>
        </div>
      </el-col>
    </el-row>
    <!-- 热卖 -->
    <!-- 热门套餐 -->
    <el-row :gutter="20" class='marginAll paddingTop23'>
      <el-col :span="12">
